...
<div style="padding:2rem;max-width:56rem;margin:0 auto">
  ...
  <div class="flex items-center gap-3 mb-6">
    ...
    <div>
      ...
      <p class="text-sm" style="color:var(--text-muted)">Définissez vos objectifs et programmez vos repas</p>
    </div>
  </div>
  ...
  <div class="card" style="padding:2.5rem">
    <form novalidate method="POST" id="planForm">
      ...
      <div class="form-group mb-6">
        ...
        <textarea name="description" id="description" class="form-textarea" placeholder="Décrivez votre objectif..."><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="form-group">
          ...
          <input type="number" name="objectif_calories" id="objectif_calories" class="form-input" placeholder="Ex: 2000" value="<?= htmlspecialchars($_POST['objectif_calories'] ?? '2000') ?>">
        </div>
      </div>
...
document.getElementById('add-repas-btn').addEventListener('click', function() {
  ...
  // Obtenir la première ligne comme template, ou en créer une si vide
  ...
  if (templateRow) {
    ...
    // Conserver logiquement le même jour ou incrementer si possible
