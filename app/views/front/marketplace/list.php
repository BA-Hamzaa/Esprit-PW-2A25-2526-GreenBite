...
<div style="padding:2rem;position:relative">
  ...
  <div class="flex items-center justify-between mb-6">
    ...
    <a href="<?= BASE_URL ?>/?page=marketplace&action=order" class="btn btn-secondary" style="border-radius:var(--radius-full)">
      <i data-lucide="shopping-cart" style="width:1rem;height:1rem"></i> Commander
    </a>
  </div>
          ...
          <div style="padding:1rem">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;padding-top:0.75rem;border-top:1px solid var(--border)">
              <div style="display:flex;align-items:center;gap:0.35rem">
                <?php if ($p['is_bio']): ?>
                  <span style="display:inline-flex;align-items:center;gap:0.25rem;color:var(--secondary);font-size:0.72rem;font-weight:600">
                    <i data-lucide="check-circle-2" style="width:0.7rem;height:0.7rem"></i> Certifié bio
                  </span>
                <?php else: ?>
                  <span style="display:inline-flex;align-items:center;gap:0.25rem;color:var(--text-muted);font-size:0.72rem">
                    <i data-lucide="map-pin" style="width:0.7rem;height:0.7rem"></i> Local
                  </span>
                <?php endif; ?>
              </div>
              <a href="<?= BASE_URL ?>/?page=marketplace&action=detail&id=<?= $p['id'] ?>"
                 class="btn btn-sm"
                 style="background:linear-gradient(135deg,#ca8a04,#d97706);color:#fff;border:none;border-radius:var(--radius-full);padding:0.3rem 0.875rem;font-size:0.75rem;box-shadow:0 3px 10px rgba(202,138,4,0.25)">
