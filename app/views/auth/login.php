...
<div id="app-loader" class="app-loader">
  <div class="app-loader-card">
    ...
    <div class="app-loader-subtitle">Préparation de votre espace personnel…</div>
...
<div style="min-height:100vh;display:flex;background:var(--background)">
  ...
  <div style="flex:1;display:flex;align-items:center;justify-content:center;padding:2rem">
    <div style="width:100%;max-width:26rem">
      ...
      <form novalidate onsubmit="event.preventDefault(); showToast('success', 'Connexion réussie ! Redirection...')" style="display:flex;flex-direction:column;gap:1.25rem">
        <div class="form-group" style="margin-bottom:0">
          ...
          <input type="email" id="login-email" class="form-input" placeholder="votre@email.com" style="padding:0.85rem 1rem;border-radius:var(--radius-xl)">
        </div>
        <div class="form-group" style="margin-bottom:0">
          ...
          <div style="position:relative">
            <input type="password" id="login-password" class="form-input" placeholder="••••••••" style="padding:0.85rem 1rem;border-radius:var(--radius-xl);padding-right:3rem">
