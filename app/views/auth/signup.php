...
<div style="min-height:100vh;display:flex;background:var(--background)">
  ...
  <div style="flex:1;display:flex;align-items:center;justify-content:center;padding:2rem">
    <div style="width:100%;max-width:26rem">
      ...
      <form novalidate onsubmit="event.preventDefault(); showToast('success', 'Compte créé ! Redirection...')" style="display:flex;flex-direction:column;gap:1rem">
...
<script>
  ...
  function showToast(type, msg) {
    ...
    t.innerHTML = '<i data-lucide="check-circle-2" style="width:1.25rem;height:1.25rem;flex-shrink:0"></i><span style="font-size:0.875rem;font-weight:500">'+msg+'</span>';
