  ...
  <div class="card" style="padding:2.5rem">
    <form novalidate method="POST" id="planForm">
      ...
      <div class="form-group mb-2">
        ...
        <input type="number" name="duree_jours" id="duree_jours" class="form-input" placeholder="Ex: 7" value="<?= htmlspecialchars($_POST['duree_jours'] ?? '') ?>" min="1" max="365" style="max-width:200px">
