    ...
    <table class="table" id="usersTable" style="width:100%;border-collapse:collapse">
      <thead>
        <tr style="background:linear-gradient(135deg,rgba(45,106,79,0.06),rgba(82,183,136,0.04));border-bottom:2px solid var(--border)">
          <th style="padding:0.75rem 0.875rem;font-size:0.72rem;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-muted)"></th>
          <th style="padding:0.75rem 0.875rem;font-size:0.72rem;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-muted)">
            <a href="<?= BASE_URL ?>/?page=admin-users&page_num=<?= $page ?>&sort_by=username&sort_dir=<?= $sortBy === 'username' ? ($sortDir === 'ASC' ? 'DESC' : 'ASC') : 'ASC' ?>"
               style="color:var(--text-muted);text-decoration:none;display:flex;align-items:center;gap:0.35rem;cursor:pointer;text-transform:uppercase;font-size:0.72rem;font-weight:700;letter-spacing:0.08em"
          ...
          <th style="padding:0.75rem 0.875rem;text-align:center;font-size:0.72rem;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--text-muted)">Actions</th>
        </tr>
      </thead>
      <tbody>
