              ...
              <tr>
                ...
                <td>
                  <div class="flex gap-2">
                    ...
                    <a href="<?= BASE_URL ?>/?page=admin-recettes&action=delete-ingredient&id=<?= $i['id'] ?>" class="icon-btn" style="color:var(--destructive)" title="Supprimer" data-confirm="Supprimer cet ingrédient ?" data-confirm-title="Supprimer" data-confirm-type="danger" data-confirm-btn="Supprimer"><i data-lucide="trash-2" style="width:0.875rem;height:0.875rem"></i></a>
                  </div>
                </td>
              </tr>
            <?php endforeach; ?>
