              ...
              <tr>
                ...
                <td>
                  <div style="display:flex;gap:0.375rem;align-items:center">
                    ...
                    <a href="<?= BASE_URL ?>/?page=admin-nutrition&action=delete&id=<?= $r['id'] ?>" class="icon-btn" style="background:rgba(239,68,68,0.06);border-color:rgba(239,68,68,0.15);color:#ef4444" title="Supprimer" data-confirm="Supprimer ce repas ?" data-confirm-title="Supprimer" data-confirm-type="danger" data-confirm-btn="Supprimer">
