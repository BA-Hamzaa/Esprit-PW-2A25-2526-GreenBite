...
<div style="padding:2rem">
  ...
  <form method="post" action="<?= BASE_URL ?>/?page=admin-article&action=add" onsubmit="return validateArticleForm();">
    <div class="card" style="padding:1.5rem;border:1px solid var(--border)">
      ...
      <!-- SUBMIT -->
      <div style="display:flex;justify-content:flex-end;border-top:1px solid var(--border);padding-top:1.2rem">
        <button type="submit" class="btn btn-primary" style="border-radius:var(--radius-full);padding:0.7rem 1.8rem">
