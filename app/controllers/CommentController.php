...
class CommentController
{
    ...
    function supprimerEtBannirBack()
    {
        ...
        if ($id > 0) {
            ...
            if ($commentaire && !empty($commentaire['pseudo'])) {
                ...
                $_SESSION['success'] = "Commentaire supprimé et <strong>" . htmlspecialchars($commentaire['pseudo']) . "</strong> est banni de cet article.";
            }
        }
    ...
    function listBack()
    {
        ...
        require_once BASE_PATH . '/app/views/backoffice/comment/list.php';
