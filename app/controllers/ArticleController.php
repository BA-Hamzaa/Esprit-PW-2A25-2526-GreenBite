...
class ArticleController
{
                ...
                foreach ($bannis as $entry) {
                    ...
                    if ($bpseudo === $pseudo) {
                        ...
                        if ($b_article_id === null || $b_article_id == $article_id) {
                            $errors[] = "🚩 Vous êtes banni et ne pouvez plus commenter sur cet article.";
                            break;
                        }
                    }
                }
    ...
    function listBack()
    {
        ...
        require_once BASE_PATH . '/app/views/backoffice/article/list.php';
    ...
    function pendingBack()
    {
        ...
        require_once BASE_PATH . '/app/views/backoffice/layouts/back_header.php';
        require_once BASE_PATH . '/app/views/backoffice/article/pending.php';
        require_once BASE_PATH . '/app/views/backoffice/layouts/back_footer.php';
    }
    ...
    function addBack()
    {
        ...
        require_once BASE_PATH . '/app/views/backoffice/layouts/back_header.php';
        require_once BASE_PATH . '/app/views/backoffice/article/add.php';
        require_once BASE_PATH . '/app/views/backoffice/layouts/back_footer.php';
    }
    ...
    function editBack()
    {
        ...
        require_once BASE_PATH . '/app/views/backoffice/layouts/back_header.php';
        require_once BASE_PATH . '/app/views/backoffice/article/edit.php';
        require_once BASE_PATH . '/app/views/backoffice/layouts/back_footer.php';
    }
    ...
    function statsBack()
    {
        ...
        require_once BASE_PATH . '/app/views/backoffice/layouts/back_header.php';
        require_once BASE_PATH . '/app/views/backoffice/article/stats.php';
        require_once BASE_PATH . '/app/views/backoffice/layouts/back_footer.php';
    }
    ...
    function mesActivitesFront()
    {
        ...
        // ── Priority 1: User is logged in via main session ──────────────────
        ...
        // ── Priority 2: Legacy PIN session (guest who entered name+PIN before) ──
        ...
        // ── Priority 3: POST form submission (guest PIN login) ───────────────
    ...
    /** Articles by logged-in username — no PIN required */
    ...
    /** Comments by logged-in username — no PIN required */
    ...
    function editMesCommentairesFront()
    {
        ...
        // ── Authorisation: session login OR valid PIN ──
        $loggedIn        = !empty($_SESSION['loggedin']) && $_SESSION['loggedin'] === true;
        ...
        require_once BASE_PATH . '/app/views/frontoffice/layouts/front_header.php';
        require_once BASE_PATH . '/app/views/frontoffice/article/edit_mes_commentaires.php';
        require_once BASE_PATH . '/app/views/frontoffice/layouts/front_footer.php';
    }
    ...
    function addFront()
    {
        ...
        require_once BASE_PATH . '/app/views/frontoffice/layouts/front_header.php';
        require_once BASE_PATH . '/app/views/frontoffice/article/add.php';
        require_once BASE_PATH . '/app/views/frontoffice/layouts/front_footer.php';
    }
    ...
    function validerArticleFront($post)
    {
        ...
        if ($titre === '' || mb_strlen($titre) < 3)
            $errors[] = "Titre obligatoire (min 3 caractères).";
        if (mb_strlen($titre) > 150)
            $errors[] = "Titre max 150 caractères.";
        if ($contenu === '' || mb_strlen($contenu) < 20)
            $errors[] = "Contenu obligatoire (min 20 caractères).";
        if ($auteur === '' || mb_strlen($auteur) < 2)
            $errors[] = "Nom obligatoire (min 2 caractères).";
    ...
    function editMesArticlesFront()
    {
        ...
        require_once BASE_PATH . '/app/views/frontoffice/layouts/front_header.php';
        require_once BASE_PATH . '/app/views/frontoffice/article/edit_mes_articles.php';
        require_once BASE_PATH . '/app/views/frontoffice/layouts/front_footer.php';
    }
